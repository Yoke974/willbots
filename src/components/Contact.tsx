              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    name="name"
                    className="w-full bg-[#0a192f] border border-[#233554] rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-[#00d1ff] text-white"
            ...
            <div className="mt-8 pt-8 border-t border-[#233554]">
              <div className="flex flex-col items-center">
                ...
                <div className="flex space-x-6">
                  <a href="mailto:willgigan244@gmail.com" className="text-[#8892b0] hover:text-[#00d1ff] transition-colors text-2xl">
                    <i className="fas fa-envelope"></i>
                  </a>
                  <a href="https://www.linkedin.com/in/will-gigan-639721376/" target="_blank" className="text-[#8892b0] hover:text-[#00d1ff] transition-colors text-2xl">
